 ...
 * during the paper trail mechanism BEFORE this {@link PaperTrail} saved.
 *
 * @param <PT>
 *          the type of a PaperTrail implementation
 */
public interface BeforePaperTrailCallback<PT extends PaperTrail> {
   ...
   */
  public void beforePaperTrail(PT paperTrail, HttpServletRequest request,
